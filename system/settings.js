...
global.owner = [
  ['-'],
  ['-'],
  ['6281370126262', 'ArdaStore', 'ardaganzofc@gmail.com', true]
...
global.APIKeys = {
    ...
    'https://api.zahwazein.xyz': 'zenzkey_1b95a31ba2bc',
    'https://api.xteam.xyz': '-',
    'https://api.xyroinee.xyz': '-',
    'https://api.neoxr.eu': 'JZiowm',
    'https://api.xfarr.com': '-',
    'https://api.zahwazein.xyz': 'zenzkey_1b95a31ba2bc',
    'https://api.betabotz.org': 'EZi69kh6',
...
if (stickerpack.spackname == '') {
  var sticker_name = 'Rara - Botz'
  var sticker_author = 'Arda Ganz'
} else {
  var sticker_name = 'Rara - Botz'
  var sticker_author = 'Arda Ganz'
}
...
global.Yoru = 'application/vnd.android.package-archive'
...
global.namebot = '© Rara-Botz v5.0.3 (Public Bot)'
...
global.email = 'ardaganzofc@gmail.com'
global.creator = "6281370126262@s.whatsapp.net"
global.nomorbot = '-'
...
global.sgh = '-'
global.sgc = ''
global.swa = 'https://wa.me/6281370126262'
...
// Watermark
global.packname = 'Rara - Botz'
global.author = '// ArdaStore'
global.wm = 'Rara - Botz'
global.wm2 = 'Riris Botz'
